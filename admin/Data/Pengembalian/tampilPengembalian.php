      ...
      <?php 
       ...
       <tbody>
        <tr>
            ...
            <td><?= $data['status']; ?></td>
            <td>
              <a href="?page=editPengembalian&kode_pengembalian=<?php echo $data['kode_pengembalian']; ?>" class="link"><img name="pencil" src="images/action/edit.png"></a>
              <a href="?page=hapusPengembalian&kode_pengembalian=<?php echo $data['kode_pengembalian']; ?>" class="link"><img name="delete" src="images/action/delete.png" onclick="return confirm('Yakin Akan di Hapus ?')"></a> 
            </td>
        </tr>
      <?php endwhile; ?>
      </tbody>
